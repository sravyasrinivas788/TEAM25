...
<div className="col-md-4 ">
    <Form.Item
        ...
        name="Leetcode"
        rules={[
            { required: true, message: 'Please enter your Leetcode URL!' },
            {
                type: 'url',
                message: 'Please enter a valid GitHub URL!',
            },
    ...
    >
        <Input className="form-control" placeholder="LeetCode Profile URL" />
    </Form.Item>
</div>
            ...
            <div className="col-md-4 ">
                <Form.Item label="Mobile" name="Mobile" rules={[{required:false}]}>
                    <Input className="form-control">
            ...
            <div className="col-md-4 ">
                <Form.Item label="Area of Study" name="Area of Study" rules={[{required:true}]}>
                    <Input className="form-control">
